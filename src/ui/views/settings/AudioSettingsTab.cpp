...
bool AudioSettingsTab::eventFilter(QObject* obj, QEvent* event)
{
...
void AudioSettingsTab::saveVstPlugins()
{
    QStringList paths;
...
void AudioSettingsTab::loadVstPlugins()
{
...
QWidget* AudioSettingsTab::createDSPCard(QVBoxLayout* parentLayout)
{
    ...
    connect(m_eqPresetCombo, &QComboBox::currentTextChanged,
            this, &AudioSettingsTab::applyEQPreset);
...
void AudioSettingsTab::rebuildBandRows()
{
    // Clear existing
...
void AudioSettingsTab::syncBandToProcessor(int bandIndex)
{
...
void AudioSettingsTab::updateEQGraph()
{
    if (!m_eqGraph) return;
...
QWidget* AudioSettingsTab::createVSTCard(QVBoxLayout* parentLayout)
{
...
void AudioSettingsTab::applyEQPreset(const QString& presetName)
{
