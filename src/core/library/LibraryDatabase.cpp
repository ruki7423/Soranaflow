...
// ── Transaction helpers ──────────────────────────────────────────────
bool LibraryDatabase::beginTransaction() { QMutexLocker lock(&m_dbMutex); return m_db.transaction(); }
bool LibraryDatabase::commitTransaction() { QMutexLocker lock(&m_dbMutex); return m_db.commit(); }
